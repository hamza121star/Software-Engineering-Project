...
describe DiscussionsController do
  ...
  let(:valid_attributes) { { "Date" => "2015-05-12" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved discussion as @discussion" do
        ...
        post :create, {:discussion => { "Date" => "invalid value" }}, valid_session
        assigns(:discussion).should be_a_new(Discussion)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested discussion" do
        ...
        Discussion.any_instance.should_receive(:update_attributes).with({ "Date" => "2015-05-12" })
        put :update, {:id => discussion.to_param, :discussion => { "Date" => "2015-05-12" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the discussion as @discussion" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Discussion.any_instance.stub(:save).and_return(false)
        put :update, {:id => discussion.to_param, :discussion => { "Date" => "invalid value" }}, valid_session
        assigns(:discussion).should eq(discussion)
      end
